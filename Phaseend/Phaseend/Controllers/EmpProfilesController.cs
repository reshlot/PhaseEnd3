...
namespace Phaseend.Controllers
{
    ...
    {
        private readonly PhaseendEmpDbContext _context;

        public EmpProfilesController(PhaseendEmpDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmpProfile>> PostEmpProfile(EmpProfile empProfile)
        {
          if (_context.EmpProfile == null)
          {
              return Problem("Entity set 'PhaseendEmpDbContext.EmpProfile'  is null.");
          }
